...
*   mex '-IC:/IPG/hil/win32-7.0.2/include' '-DLINUX' tire_lin.c
*   mex '-IC:/IPG/hil/win32-7.0.2/include' '-DWIN32' tire_lin.c
* Compile in 64-bit Matlab with one of
*   mex '-IC:/IPG/hil/win32-7.0.2/include' '-DLINUX' '-DLINUX64' tire_lin.c
*   mex '-IC:/IPG/hil/win32-7.0.2/include' '-DWIN32' '-DWIN64'   tire_lin.c
*/
