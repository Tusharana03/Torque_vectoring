...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win32 7.0.2 2018-09-12",
    "libcarmaker.a	CarMaker win32 7.0.2 2018-09-12",
    "libipgdriver.a	IPGDriver win32 7.0.1 2018-04-26",
    "libipgroad.a	IPGRoad win32 7.0.2 2018-09-07",
...
static const char *CompileFlags[] = {
    "-O3 -march=i686 -DNDEBUG -DWIN32 -DCM_NUMVER=70002",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 7.0.2 - Car_Generic",          /* App_Version         */
    "291",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2018-09-12 13:20:39",  /* App_CompileTime */
