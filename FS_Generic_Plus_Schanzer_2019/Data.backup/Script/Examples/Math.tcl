...
# wait until Time is ~15 seconds
WaitForCondition {$Qu(Time) > 15}
Log "* After ~15 seconds the values are:\n"
 
# after ~15 seconds set the new variables 
set Velocity      $Qu(Car.v)
set InstSlipAng   $Qu(Sensor.SAngle.A00.Ang)
